...
#[no_mangle]
pub static __INTERRUPTS: [Vector; 8] = [
    Vector { _reserved: 0 },
    Vector { _reserved: 0 },
    Vector { _reserved: 0 },
    Vector { _reserved: 0 },
...
impl Uart1 {
    ...
    pub const PTR: *const uart1::RegisterBlock = 0x4000_0000 as *const _;
...
impl Uart2 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const uart2::RegisterBlock = 0x5000_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
